            ...
            <div className="mx-auto max-w-[1680px] space-y-5 pb-12">
                ...
                {showCreate && <form onSubmit={createGroup} noValidate className="rounded-2xl border border-indigo-200 bg-indigo-50 p-5">
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <label><span className="mb-1 block text-xs font-extrabold text-indigo-900">จำนวนที่รองรับ</span><input type="number" min="1" value={form.capacity} onChange={event => setForm(previous => ({ ...previous, capacity: event.target.value }))} className="min-h-11 w-full rounded-xl border border-field px-3 text-sm font-bold" /></label>
                    </div>
