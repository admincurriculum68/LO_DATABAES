    ...
    return (
        <Layout title="ศูนย์รับรองผลรายด้านความสามารถ">
            <div className="mx-auto max-w-[1680px] space-y-5 pb-12">
                ...
                {loadError && <section className="rounded-2xl border border-rose-200 bg-rose-50 p-5" role="alert"><div className="flex gap-3"><AlertCircle className="h-5 w-5 shrink-0 text-rose-700" /><div><h2 className="font-extrabold text-rose-950">เปิดศูนย์รับรองผลไม่ได้</h2><p className="mt-1 text-sm text-rose-800">{loadError}</p><button onClick={loadApprovalData} className="mt-3 inline-flex min-h-11 items-center gap-2 rounded-xl bg-rose-700 px-4 text-sm font-bold text-white"><RotateCcw className="h-4 w-4" />ลองใหม่</button></div></div></section>}
