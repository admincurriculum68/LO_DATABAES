    ...
    return (
        <Layout title="ศูนย์ตั้งค่าข้อมูล">
            <div className="mx-auto max-w-6xl space-y-5 pb-12">
                <header className="border-b border-line pb-5"><div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="text-2xl font-bold text-slate-950">ตั้งค่าข้อมูลทีละขั้น</h1><p className="mt-1 text-sm leading-6 text-slate-600">ทำจากบนลงล่าง ระบบบอกว่าส่วนไหนพร้อมและควรทำอะไรต่อ</p></div><div className="surface-selected rounded-xl px-4 py-3 text-sm font-bold text-blue-900">พร้อม {readyCount}/{readiness.total} ขั้น</div></div><div className="mt-4 h-2 overflow-hidden rounded-full bg-slate-100"><div className="action-primary h-full rounded-full" style={{ width: `${readiness.percent}%` }} /></div></header>
