...
// คำในชื่อวิชา → คำในชื่อด้าน ใช้เดาเท่านั้น ฝ่ายวิชาการต้องตรวจก่อนบันทึกเสมอ
// ภาษาไทยช่วงชั้นต้นแยกด้านการอ่านและการเขียน ช่วงชั้นปลายรวมเป็นด้านภาษาและการสื่อสาร จึงใส่ไว้ทั้งสามคำ
...
const SUBJECT_AREA_RULES = [
    ...
    { pattern: /อังกฤษ|\benglish/i, areas: ['ภาษาอังกฤษ'] },
    { pattern: /จีน|\bchinese/i, areas: ['ภาษาจีน'] },
];
